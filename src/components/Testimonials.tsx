...
const reviews = [
  {
    ...
    date: "Hace 2 meses",
    rating: 5,
    text: "Excelente servicio, llevé mi camioneta con un problema de motor y la dejaron como nueva. Muy profesionales y honestos con los precios. Totalmente recomendados.",
    initial: "C",
    verified: true,
  },
  {
    ...
    date: "Hace 1 mes",
    rating: 5,
    text: "El mejor taller de la zona. Siempre me atienden rápido y explican todo el trabajo que realizan. Se nota que saben lo que hacen y cuidan cada detalle.",
    initial: "M",
    verified: true,
  },
  {
    ...
    date: "Hace 3 semanas",
    rating: 5,
    text: "Profesionales de primera. He llevado todos mis autos aquí y jamás he tenido una mala experiencia. Los mecánicos son muy amables y el servicio es impecable.",
    initial: "R",
    verified: true,
  },
  {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {reviews.map((review, index) => (
            <motion.div
              ...
              className="bg-[hsl(0,0%,7%)] border border-white/10 rounded-2xl p-6 relative group hover:border-red-600/30 transition-all duration-300"
            >
              {/* Google Icon/Logo */}
              <div className="absolute top-6 right-6">
                <svg viewBox="0 0 24 24" className="w-6 h-6 fill-gray-600/50">
              ...
              <div className="flex items-start gap-4 mb-4">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-red-600 to-red-800 flex items-center justify-center text-white font-heading text-xl shadow-lg shadow-red-900/20">
                  {review.initial}
                </div>
                <div>
                  <div className="flex items-center gap-1.5">
                    <h3 className="text-white font-medium leading-none">{review.name}</h3>
                    {review.verified && (
              ...
              <div className="mt-4 flex items-center gap-2 text-xs text-gray-500 font-medium">
                ...
                <span className="text-gray-600 hover:text-red-500 cursor-pointer transition-colors">Original</span>
              </div>
            </motion.div>
          ))}
        </div>
